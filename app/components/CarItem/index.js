    ...
    return (
      <View style={[styles.blockContain, style]}>
        <TouchableOpacity onPress={onPress} activeOpacity={0.9}>
          ...
          <View style={[styles.blockRow, { marginTop: 5 }]}>
            <Text headline semibold style={{ fontFamily: "Cairo-Regular" }}>
              {title}
            </Text>
            <Text
              title3
          ...
          <View
            style={[
              styles.blockRow,
              { marginBottom: 10, fontFamily: "Cairo-Regular" }
            ]}
          >
            <Text body2 style={{ fontFamily: "Cairo-Regular" }}>
              {name}
            </Text>
            <Text
              body1
